...
// const input = await fs.readFile('../../../input/day-3/example.txt', 'utf8');
const input = await fs.readFile('../../../input/day-3/challenge.txt', 'utf8');
...
//   const isInRange = 0 <= l && l < lines.length && 0 <= p && p < lines[l].length;
